                    ...
                    <div id="maincontainer" style = "padding: 0px 10% 0px 20%;">
                        ...
                        ​  <div>
                          ...
                          <b>
                            <div style="textcolor:black;">
                                ...
                                <input type="text" name="name" style="width: 40%;margin-top: -3%;margin-left:0;" class = "form-control" id="prodect code" value="<?php echo $name;?>" required >
                        ...
                        <br>
                            ...
                            <div style="textcolor:black;">
                              ...
                              <input type="text" id="cvv" name="cvv" style="width:40%;" value="<?php echo $cvv;?>" placeholder=" " required >
